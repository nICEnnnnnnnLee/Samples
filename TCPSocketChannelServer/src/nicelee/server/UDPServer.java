...
//					NATSessionManager.createSession(Integer.parseInt(matcher.group(2)), CommonMethods.ipStringToInt("114.114.114.114"), (short) 53);
					NATSessionManager.createSession("udp", packet.getPort(),
							CommonMethods.ipStringToInt("114.114.114.114"), (short) 53);
					...
					Integer port = NATSessionManager.getPort("udp", session);
					if (port == null) {
						continue;
					}
					DatagramPacket sendPacket = new DatagramPacket(receMsgs, packet.getLength(),
